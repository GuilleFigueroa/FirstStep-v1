    ...
    <div className="space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-6">
            <div className="text-center px-4 py-2 bg-white/60 rounded-lg backdrop-blur-sm">
              ...
              <div className="text-xs text-slate-500">Cerrados</div>
            </div>
            <div className="text-center px-4 py-2 bg-white/60 rounded-lg backdrop-blur-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <Card className="border-l-4 border-l-blue-500">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Procesos Cerrados</CardTitle>
            <CheckCircle className="h-4 w-4 text-blue-600" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold text-blue-600">{stats.completedProcesses}</div>
            <p className="text-xs text-muted-foreground">
              {stats.completedProcesses === 0 ? 'Aún no hay cerrados' : 'Procesos cerrados'}
            </p>
          </CardContent>
        </Card>
